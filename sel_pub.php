...
<body class="color-fondo">
	...
	<div class="w3-row-padding w3-margin-top" id="contenido">
		<div class = "w3-container w3-white w3-card w3-row-padding" id="sel-residencia">
			<h2 class='subt'><?php echo "$nombre_pub"; ?></h2>
		...
		$lista = procesarComentarios::getComentarios("$id", 1);
	...
	<?php 
		...
		<div class='botones-admin'>
			<?php
				echo " <p><a class = 'boton-admin' href = 'modificarPub.php?id=$id'>Modificar evento</a></p>";

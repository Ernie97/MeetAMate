...
<body class="color-fondo">
	<div class="w3-content w3-sand">
		...
		<div class="w3-margin-left w3-margin-right w3-margin-top w3-margin-bottom" id="contenedor-sel-general">

				<div class = "w3-container w3-white w3-card w3-row-padding" id="sel-residencia">
					<h2 class='subt'><?php echo "$nombre_quedada"; ?></h2>
		...
		<div class='botones-admin'>
			<?php
				echo "<p><a class = 'boton-admin' href = 'modificarErasmus.php?id=$id'>Modificar Erasmus</a></p>";
				echo "<p><a class='boton-admin' href = 'codesincss/borrarEvento.php?id=$id&tipo=$tipo'>Eliminar Erasmus</a></p>";
			?>
		</div>

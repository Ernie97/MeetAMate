...
class Usuario
{
    ...
    public static function crea($Nick_Name, $ID_Usuario, $Nombre_Usuario, $Primer_Apellido, $Segundo_Apellido, $Imagen_Perfil, $Fecha_Nacimiento, $Correo, $Telefono, $Test, $Contrasena, $Es_Admin)
    {
        ...
        $user = new Usuario($Nick_Name, $ID_Usuario, $Nombre_Usuario, $Primer_Apellido, $Segundo_Apellido, $Imagen_Perfil, $Fecha_Nacimiento, $Correo, $Telefono, $Test, self::hashPassword($Contrasena), $Es_Admin);
